...
// CATATAN PERBAIKAN:
// Sebelumnya file ini punya tipe CoffeeShop sendiri (id: number, images:
// string[], isPopular, isNew, dll) yang BEDA dari tipe resmi di
// types/coffeeShop.ts (id: string, imageUrl: string, isOpenNow, dll).
// Ini bahaya karena komponen seperti CoffeeShopCard.tsx sudah dibangun
// mengikuti types/coffeeShop.ts, jadi data dummy di sini disesuaikan
// supaya cocok dan tidak error saat dipakai bersama.
//
// Field yang dulu ada di sini tapi tidak ada di tipe resmi (whatsapp,
// instagram, googleMapsUrl, menu, openingHours, isPopular, isNew)
// dipindahkan ke DetailExtra terpisah, supaya halaman Detail nanti
// tetap bisa memakainya tanpa mengotori tipe utama CoffeeShop yang
// dipakai di banyak komponen (Card, Explorer, dll).
...
export type CoffeeShopWithExtra = CoffeeShop & DetailExtra;
...
const base = (
  ...
  rating: number,
  priceRange: string,
  flags: { isFeatured: boolean; isPopular: boolean; isNew: boolean },
): CoffeeShopWithExtra => ({
  id: String(id),
  name,
  slug,
  ...
  address: `Jl. ${district} Raya No. ${12 + id}, Jember`,
  reviewCount: 34 + id * 19,
  openingHours: "Senin–Minggu, 08.00–23.00 WIB",
  facilities: ["Wi-Fi", "Colokan", "Parkir", "Area outdoor"],
  imageUrl: images[id % 4],
  menu: [
    { name: "Es Kopi Susu", price: "Rp18.000" },
    { name: "Cappuccino", price: "Rp24.000" },
    { name: "Croissant Butter", price: "Rp19.000" },
  ],
  whatsapp: "6281234567890",
  instagram: `https://instagram.com/${slug}`,
  googleMapsUrl: "https://maps.google.com/?q=Jember",
});

export const coffeeShops: CoffeeShopWithExtra[] = [
